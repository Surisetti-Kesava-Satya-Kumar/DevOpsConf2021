...
Write-Debug "ClientSecret          : $(if (![System.String]::IsNullOrWhiteSpace($ClientSecret)) { 'AY*EMtSuOLtuDcouAI77'; } else { '<not present>'; })";
Write-Debug "TenantId              : $(if (![System.String]::IsNullOrWhiteSpace($TenantId)) { '84f1e4ea-8554-43e1-8709-f0b8589ea118'; } else { '<not present>'; })";
